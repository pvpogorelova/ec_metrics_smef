...
* Мы также можем использовать функции бутстрапа коэффициентов. Например, следующие команды создают 
* критические значения начальной загрузки на уровне значимости 5% t-статистики для коэффициента наклона:
reg y x
scalar b = _b[x]
